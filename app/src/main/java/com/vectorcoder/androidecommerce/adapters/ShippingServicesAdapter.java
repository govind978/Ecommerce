...
import com.vectorcoder.androidecommerce.fragments.Shipping_Methods;
...
public class ShippingServicesAdapter extends RecyclerView.Adapter<ShippingServicesAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        if (shipping_methods_fragment.getSelectedShippingService().getName().equalsIgnoreCase(shippingService.getName())) {
